...
def exibir_extrato(clientes):
    ...
    extrato = ""
    if not transacoes:
        extrato = "Nunhuma movimentação localizada."
    else:
...
def criar_cliente(clientes):
    ...
    endereco = input(
        "Informe seu endereço (rua, n° - bairro - cidade - estado): ")
...
def criar_conta(numero_conta, clientes, contas):
    ...
    if not cliente:
        print("\n!!! Erro! Cliente não encontrado, Criação de conta encerrado! !!!")
        return
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            print(
                "\n!!! Opção incorreta, por favor selecione a opção desejada. !!!")
